...
const ScheduleAppoinments = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axiosInstance.post('/appointment/schedule', {date, one, two, three , zoomLink}).then(() => {
        ...
        <>
            <Container style={{ marginTop: "30px" }}>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Row>
                        <Col sm={6} md={4}>
                            <p>Provide Zoom Meeting Link</p>
                            <Form.Control value={zoomLink} name="zoom" onChange={(e) => { setzoomLink(e.target.value) }} type="text" />
                        </Col>
                    </Row>
