...
const bookAppointmentController = async (req, res) => {
    ...
    try {
        ...
        var zoom = await Appointment.findOne({ date: date });
        zoom = zoom.zoom;
        ...
        const addPatient = new Patient({docEmail: docEmail, email:req.email, firstname, lastname, appointmentId: Date[0]._id, slot, patientId: uniqueCode, date , zoom });
